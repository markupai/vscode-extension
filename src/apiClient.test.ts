...
describe('MarkupAIContentChecker', () => {
  ...
  describe('checkContent', () => {
    it('should create workflow and poll for results', async () => {
      ...
      expect(mockClientInstance.styleSuggestions.getStyleSuggestion).toHaveBeenCalledWith(workflowId);
    });
    ...
    it('should handle workflow failures', async () => {
      ...
      await expect(
        checker.checkContent('test', 'american_english' as any, 'ap')
      ...
      mockClientInstance.styleSuggestions.getStyleSuggestion.mockImplementation(() => {
        ...
        return Promise.resolve({
          ...
          original: {
            issues: [],
            scores: {
              quality: { score: 100, grammar: { score: 100 }, consistency: { score: 100 }, terminology: { score: 100 } }
            }
          }
        });
      });
    ...
    it('should map grammar category to grammar type', async () => {
      ...
      mockClientInstance.styleSuggestions.getStyleSuggestion.mockResolvedValue({
        ...
        original: {
          ...
          scores: {
            quality: { score: 90, grammar: { score: 90 }, consistency: { score: 90 }, terminology: { score: 90 } }
          }
        }
      });
    ...
    it('should map clarity category to clarity type', async () => {
      ...
      mockClientInstance.styleSuggestions.getStyleSuggestion.mockResolvedValue({
        ...
        original: {
          ...
          scores: {
            quality: { score: 85, grammar: { score: 90 }, consistency: { score: 80 }, terminology: { score: 85 } }
          }
        }
      });
